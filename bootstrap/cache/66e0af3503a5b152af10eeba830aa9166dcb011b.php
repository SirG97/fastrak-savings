...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-12">
                <div class="login-wrapper d-flex justify-content-center flex-column">
                    <div class="login-box">
                        ...
                        <form action="/contribute" method="POST" id="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" value="" id="email" name="email">
                            </div>
                            <div class="form-group">
                                <label for="password" class="font-weight-bold">Pin</label>
                                <input type="text" class="form-control form-control-lg" value="" id="password" name="password">
                            </div>
